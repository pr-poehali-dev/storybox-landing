...
export default function ParentsIndex() {
  ...
  return (
    <div style={{ fontFamily: "'Open Sans', sans-serif" }}>
      ...
      <ParentsHeroSection openConsult={openConsult} />
      ...
      <footer style={{ background: "#0F1419" }} className="border-t border-white/10 pt-12 pb-8 px-4 md:px-6">
        ...
        <div className="max-w-7xl mx-auto border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-[13px]" style={{ color: "rgba(255,255,255,0.3)" }}>© 2025 StoryBox. Все права защищены.</p>
          <p className="text-[13px]" style={{ color: "rgba(255,255,255,0.3)" }}>ИП Гурбатова Виктория Игоревна · ИНН 550509469563</p>
        </div>
      </footer>
    </div>
  );
