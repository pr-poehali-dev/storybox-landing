...
const STEPS = [
  {
    ...
    img: "https://cdn.poehali.dev/projects/93b2577c-d64f-4b54-a5df-edacb89bda77/bucket/b53f8194-604a-45ef-8297-1e15c9ef28cd.png",
  },
  {
    n: "2",
    title: "Интервью",
  ...
  return (
    <>
      ...
      <section id="book" className="py-10 md:py-16">
        ...
        >
          {BOOK_FEATURES.map((f) => (
            <div key={f.title} className="sb-card flex-shrink-0 overflow-hidden !p-0 flex flex-col" style={{ width: "76vw", maxWidth: 300 }}>
              {f.image && (
        ...
        <div className="hidden md:flex items-stretch gap-3 max-w-7xl px-0 mx-[25px]">
          <button
