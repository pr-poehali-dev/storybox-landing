...
const INTERVIEW_STEPS = [
  {
    icon: "MapPin",
    title: "Место для съёмки",
    desc: "Мы можем записать интервью в профессиональной подкаст-студии в вашем городе, у вас дома или через Zoom.",
  },
  {
    icon: "Users",
    title: "Интервьюеры",
    desc: "Нашими интервьюерами являются проверенные психологи, умеющие профессионально и бережно задавать вопросы. Также интервьюером может быть ваш родственник или друг.",
  },
  {
    icon: "MessageCircle",
    title: "Вопросы",
    desc: "Мы корректируем стандартные списки вопросов под каждого клиента для того, чтобы в полной мере раскрыть его внутренний мир.",
  },
  {
    icon: "ShieldCheck",
      ...
      <div className="md:hidden">
        ...
        <div className="px-4 pt-7">
          <h2 className="text-[24px] font-bold text-black mb-3 leading-tight">
            Сохраним внутренний мир в формате видеоинтервью
          </h2>
          <p className="text-[15px] text-[#444] leading-relaxed mb-6">
            Кроме книг воспоминаний, мы записываем интервью, которые сохранят в вечности ваш внутренний мир, истории старших родственников, а также мысли ваших детей в разные периоды жизни.
          </p>
