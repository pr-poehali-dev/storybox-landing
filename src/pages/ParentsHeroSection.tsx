...
interface ParentsHeroSectionProps {
  openConsult: () => void;
}

export default function ParentsHeroSection({ openConsult }: ParentsHeroSectionProps) {
        ...
        <div className="md:hidden">
          ...
          <div className="bg-white px-5 pt-7 pb-10">
            <h1 className="leading-tight mb-4 text-[32px] font-bold" style={{ color: "#00a4e3" }}>
              Уникальный подарок для ваших родителей
            </h1>
            <p className="text-[16px] text-[#444] leading-relaxed mb-6">
              Мы бережно интервьюируем ваших родителей, помогаем собрать фотографии и создаём красивую книгу, которая сохранит семейные истории на годы и станет отличным подарком на юбилей
            </p>
